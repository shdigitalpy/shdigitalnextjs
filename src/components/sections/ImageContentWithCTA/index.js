...
const ImageContentWithCTA = ({ data }) => {
    const {
        reverse = false,
        title,
        subTitle,
        ...
        <section className="image-content-with-cta container">
            ...
            <div className="main-wrapper md:flex">
                ...
                <FramerMotionAnimation
                    ...
                    <Link href={ctaUrl} className="cta-btn btn-primary flex bg-primary items-center text-white">
                        { ctaText }
...
export default ImageContentWithCTA;
